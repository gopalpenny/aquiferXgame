...
This vignette will show you the basic utilization of the package. First we load the `tidyverse` package for easy data wrangling. We also load the `genevoisgame` package.
...
### Confned aquifer: trust vs trust
...
Game simulation takes longer for unconfined aquifers because the underlying equations are nonlinear and must be evaluated numerically.
